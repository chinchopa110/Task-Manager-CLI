...
namespace WindowProject {
	...
	public ref class UpdatePrioritet : public System::Windows::Forms::Form
	{
	public:
		UpdatePrioritet(void)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Size = System::Drawing::Size(296, 49);
			this->label2->TabIndex = 1;
			this->label2->Text = L"New Prioritet:";
			// 
			// textBox1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &UpdatePrioritet::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &UpdatePrioritet::button2_Click);
			// 
			// UpdatePrioritet
			// 
			...
			this->Name = L"UpdatePrioritet";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"UpdatePrioritet";
...
#pragma endregion
		...
		System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			MessageBox::Show("The task prioritet has been updating", "Success", MessageBoxButtons::OK, MessageBoxIcon::Information);
