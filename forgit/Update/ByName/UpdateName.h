...
namespace WindowProject {
	...
	public ref class UpdateName : public System::Windows::Forms::Form
	{
	public:
		UpdateName(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(321, 49);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Current Name:";
			// 
			// label2
			// 
			...
			this->label2->Size = System::Drawing::Size(255, 49);
			...
			this->button1->Click += gcnew System::EventHandler(this, &UpdateName::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &UpdateName::button2_Click);
			// 
			// UpdateName
			// 
			...
			this->Name = L"UpdateName";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"UpdateName";
...
#pragma endregion
		...
		System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			MessageBox::Show("The task name has been updating", "Success", MessageBoxButtons::OK, MessageBoxIcon::Information);
