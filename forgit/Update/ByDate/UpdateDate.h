...
namespace WindowProject {
	...
	public ref class UpdateDate : public System::Windows::Forms::Form
	{
	public:
		UpdateDate(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Size = System::Drawing::Size(334, 98);
			this->label2->TabIndex = 1;
			this->label2->Text = L"New Date:\r\n(DD-MM-YYYY)";
			// 
			// textBox1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &UpdateDate::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &UpdateDate::button2_Click);
			// 
			// UpdateDate
			// 
			...
			this->Name = L"UpdateDate";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"UpdateDate";
...
#pragma endregion
		...
		System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			MessageBox::Show("The task date has been updating", "Success", MessageBoxButtons::OK, MessageBoxIcon::Information);
